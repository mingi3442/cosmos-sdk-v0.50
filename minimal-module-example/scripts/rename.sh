...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    find . -not -path './.*' -type f -exec sed -i -e "s,leemingi/checkers,$MODULE_NAME,g" {} \;
...
mv proto/leemingi/checkers/* proto/$MODULE_NAME
...
# credits
echo "# This Cosmos SDK module was generated using <https://github.com/leemingi/checkers>" > THANKS.md
