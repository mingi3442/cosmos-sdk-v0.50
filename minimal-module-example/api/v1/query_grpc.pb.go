...
const (
	Query_Counter_FullMethodName  = "/leemingi.checkers.v1.Query/Counter"
	Query_Counters_FullMethodName = "/leemingi.checkers.v1.Query/Counters"
	Query_Params_FullMethodName   = "/leemingi.checkers.v1.Query/Params"
)
